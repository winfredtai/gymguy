...
def update_product_post():
    ...
    if product.product_id is None:
        error_message = "Cannot not find old tittle."
    elif title is None:
        error_message = "Tittle cannot be empty."
    elif description is None:
        error_message = "Description cannot be empty."
    elif price < product.price:
        error_message = "Price can only be increased."
    else:
        success = update_product(old_title=old_title,
                                 newTitle=title,
